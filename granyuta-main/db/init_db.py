...
def init_database():
    ...
    try:
        ...
        baths = [
            Bathhouse(
                name='Баня Викинг',
                description='Баня викинг - размеры от 3 до 6 метров, комплектация индивидуальная.',
                price=0,
                image=json.dumps([
            ...
            Bathhouse(
                name='Баня квадро из кедра 3 метра',
                ...
                image=json.dumps([
                    ...
                    'image/3x3/3.jpg',
                    'image/3x3/3ез имени.jpg',
                    'image/3x3/WhatsApp Image 2025-11-29 at 22.19.33.jpeg',
                    'image/3x3/Без им434ени.jpg',
                    'image/3x3/Без име34ни.jpg',
                    'image/3x3/Без име3ни.jpg',
                    'image/3x3/Без имени.jpg',
                ], ensure_ascii=False),
                tags='баня,квадро',
            ...
            Bathhouse(
                name='Баня квадро из кедра 4 метра',
            ...
            Bathhouse(
                name='Баня квадро из кедра 5 метров',
            ...
            Bathhouse(
                name='Баня квадро из кедра 2 метра',
                ...
                image=json.dumps([
                    ...
                    'image/2x2/2Без имени.jpg',
                    'image/2x2/3Без имени.jpg',
                    'image/2x2/Без и434мени.jpg',
                    'image/2x2/Без и43мени.jpg',
                    'image/2x2/Без имени.jpg',
                    'image/2x2/Без имени43.jpg',
                ], ensure_ascii=False),
                tags='баня,бочка',
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        try:
            ...
            # Если нет интерактивного ввода, используем опцию по умолчанию
            print("Интерактивный ввод недоступен. Выполняется обычное обновление...")
            choice = '1'
